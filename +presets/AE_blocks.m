...
% ... (ratios and segments are correct) ...
...
for i = 1:5
    ...
    cfg.segments(i).n_trials = 800;
    cfg.segments(i).ratios = ratios(i);
end


% --- Common Parameters ---
% CORRECTED LINE: "train" is now "pip_train"
cfg.stim_params.s1_type = "pip_train";
cfg.stim_params.s2_type = "noise";
cfg.stim_params.s1_freq = 4000; % Frequency for the pips
cfg.stim_params.s2_freq = 8000; % Not used for noise, but good to have
